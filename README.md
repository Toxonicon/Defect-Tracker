# Defect-Traker - Система управления дефектами в строительстве

![Defect-Traker Logo](docs/logo.png)
...
**Defect-Traker** - это веб-приложение для управления дефектами и недостатками, выявленными в процессе строительства и эксплуатации объектов. Система позволяет эффективно отслеживать, документировать и исправлять выявленные проблемы на строительных объектах.
...
```bash
git https://github.com/Toxonicon/Defect-Tracker.git
cd DEFECT-TRAKER
```
...
```bash
cd server
psql -U postgres -d Defect-Traker -f sql/init.sql
```
...
git clone https://github.com/Toxonicon/Defect-Tracker.git
cd campusfix
...
# Просмотр логов
pm2 logs defect-traker-server

# Перезапуск
pm2 restart defect-traker-server

# Остановка
pm2 stop defect-traker-server
```
...
**Автор проекта:** Toxonicon

**Email:** support@defect-traker.com

**GitHub:** [https://github.com/Toxonicon/Defect-Tracker](https://github.com/Toxonicon/Defect-Tracker)
...
**CampusFix** - Эффективное управление качеством строительства
